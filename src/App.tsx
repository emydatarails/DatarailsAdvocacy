    ...
    <div className="min-h-screen" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <main>
        ...
        <section className="py-24 px-6 md:px-12" style={{ background: '#FFF9F1' }}>
          <div className="max-w-7xl mx-auto">
            <SectionHeader
              label="About Datarails"
              title={<>Get actionable insights with the <span className="kw-pink">AI-powered FP&A</span> platform.</>}
              description="Our mission: enable finance teams to discover novel prospects in the era of technology."
            />

            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-4">
              {[
                { num: '>$100M', label: 'Market Cap' },
                { num: '>1,500', label: 'Onboarded Clients' },
                ...
                >
                  ...
                  >
                    {s.num.startsWith('>') ? (
                      <>
                        <span style={{ color: '#FA3576' }}>&gt;</span>
                        {s.num.slice(1)}
                      </>
                    ) : s.num}
                  </div>
                  <div style={{ fontSize: 18, color: '#595959', marginTop: 10 }}>{s.label}</div>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        {/* ════════════════════════════════════════
            KEY POINTS (Why Datarails) — cream
        ════════════════════════════════════════ */}
        <section className="py-24 px-6 md:px-12" style={{ background: '#FFF9F1', borderTop: '1px solid #FFEFD9' }}>
          <div className="max-w-7xl mx-auto">
            <SectionHeader
              label="Why It Works"
              title={<>What to <span className="kw-pink">write about</span></>}
              ...
              {[
                {
                  ...
                  title: <>Real-time <span className="kw-pink">Visibility</span></>,
                  body: 'Leadership now has live answers — no more waiting for the finance team to pull another report.',
                },
                {
                  icon: <FileText size={24} />,
                  title: <>Month-end <span className="kw-pink">Close</span></>,
                  body: 'What used to take 10+ days now wraps in half the time. A process people used to dread.',
                },
                {
                  icon: <Tag size={24} />,
                  title: <>Scenario <span className="kw-pink">Modeling</span></>,
                  body: 'CFO asks for a new scenario with 2 hours\' notice. Now that\'s not a crisis — it\'s a routine task.',
                },
                {
                  icon: <Table2 size={24} />,
                  title: <>Excel <span className="kw-pink">Add-in</span></>,
                  body: 'The tools your team already knows, connected to a single source of truth. No rip-and-replace.',
                },
              ].map((card, i) => (
                <motion.div
                  key={i}
                  ...
                  className="card-light p-9 flex flex-col gap-5"
                  style={{ minHeight: 280 }}
                >
                  <span
                    style={{
                  ...
                  <h4 style={{ fontWeight: 600, fontSize: 20, lineHeight: 1.25, color: '#0C142B' }}>
                    {card.title}
                  </h4>
                  <p style={{ fontSize: 15, color: '#595959', lineHeight: 1.6 }}>{card.body}</p>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <section className="py-24 px-6 md:px-12" style={{ background: '#FFF9F1', borderTop: '1px solid #FFEFD9' }}>
          <div className="max-w-7xl mx-auto">
            <SectionHeader label="Trusted from Day One" title="What our advocates say" />
            ...
            >
              "Datarails replaced a dozen spreadsheets with{' '}
              <span className="kw-pink">one source of truth</span>. We close
              the books in half the time and finally trust the numbers."
            </blockquote>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 18 }}>
              <div
                style={{
                  ...
                  background: '#FFEFD9',
                  border: '2px solid #FA3576',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  color: '#FA3576', fontWeight: 600, fontSize: 20,
                  flexShrink: 0,
                }}
              >
                JM
              ...
              <div>
                <div style={{ fontWeight: 600, fontSize: 18, color: '#0C142B' }}>Jordan M.</div>
                <div style={{ fontSize: 15, color: '#595959' }}>Head of FP&amp;A · Series B SaaS Company</div>
              </div>
            </div>
          </div>
        </section>

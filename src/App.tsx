        ...
        >
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              onClick={generate}
              disabled={loading}
              className="w-full bg-white/5 border border-white/10 text-slate-400 py-3 rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-white/10 hover:text-slate-300 transition-all flex items-center justify-center gap-2 disabled:opacity-40"
            >
              {loading ? (
